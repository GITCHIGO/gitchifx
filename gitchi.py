...
def now_brussels():
    """Huidige tijd in Brussel (automatisch zomer/wintertijd)."""
    return datetime.datetime.now(BRUSSELS_TZ)
...
def fmt_brussels(dt=None):
    ...
    if dt is None:
        ...
        # Naive datetime behandelen als UTC
        dt = _pytz.utc.localize(dt).astimezone(BRUSSELS_TZ)

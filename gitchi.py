...
<div id="app">
  ...
  <div id="right">
    ...
    <div class="card" id="bt-form" style="display:none">
      ...
      <div class="card-body">
        <div class="form-grid">
          <div class="form-group"><label>Pair</label><select id="bt-pair" onchange="updateBtPairFields()"><option value="EURUSD">EUR/USD</option><option value="GBPUSD">GBP/USD</option><option value="XAUUSD">XAU/USD</option><option value="BOTH">EUR+XAU</option></select></div>
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <select id="bt-m-pair">
            ...
            <option value="BOTH">EUR+XAU</option>
          </select>
        </div>
        <div class="form-group">
